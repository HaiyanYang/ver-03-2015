...
pure subroutine set_coh3d6_element (elem, connec, istat, emsg)
! Purpose:
...
pure subroutine extract_coh3d6_element (elem, fstat, connec, ig_points, &
...
pure subroutine integrate_coh3d6_element (elem, nodes, material, K_matrix, &
