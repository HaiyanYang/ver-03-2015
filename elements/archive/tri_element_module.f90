    ...
    subroutine extract_tri_element(elem,curr_status,key,connec,matkey,theta,ig_point,sdv)
    ...
    subroutine integrate_tri_element(elem,K_matrix,F_vector,planestrain)
            ...
            select case (mattype)
                ...
                case ('lamina')
                    ...
                    if(failure) then
                        ...
                        call ddsdde(lib_lamina(typekey),clength,dee,strain=tmpstrain,stress=tmpstress,&
