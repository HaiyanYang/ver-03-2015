    ...
    subroutine extract_brick_element(elem,curr_status,key,connec,matkey,plyangle,stress,strain,ig_point,sdv,nstep,ninc)
    ...
    subroutine integrate_brick_element(elem,K_matrix,F_vector,nofailure)
    ...
    use glb_clock_module                ! global analysis progress (curr. step, inc, time, dtime)
        ...
        clength=zero
        call elem_ctips_origin('brick',theta,coords,edg,nedge,ctip)
