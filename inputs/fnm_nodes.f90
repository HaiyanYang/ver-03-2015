...
use fnode_module,     only: update    
  ...
  call update(node_list(49),        x=[-1.0_DP,-1.0_DP,0.2_DP],        u=[ZERO,ZERO,ZERO])
  call update(node_list(50),        x=[1.0_DP,-1.0_DP,0.2_DP],        u=[ZERO,ZERO,ZERO])
  ...
  call update(node_list(53),        x=[-1.0_DP,-1.0_DP,0.3_DP],        u=[ZERO,ZERO,ZERO])
  call update(node_list(54),        x=[1.0_DP,-1.0_DP,0.3_DP],        u=[ZERO,ZERO,ZERO])
  call update(node_list(55),        x=[-1.0_DP,1.0_DP,0.3_DP],        u=[ZERO,ZERO,ZERO])
  call update(node_list(56),        x=[1.0_DP,1.0_DP,0.3_DP],        u=[ZERO,ZERO,ZERO])
  ...
  call update(node_list(73),            x=[ZERO,ZERO,ZERO],            u=[ZERO,ZERO,ZERO])
  call update(node_list(74),            x=[ZERO,ZERO,ZERO],            u=[ZERO,ZERO,ZERO])
  call update(node_list(75),            x=[ZERO,ZERO,ZERO],            u=[ZERO,ZERO,ZERO])
  call update(node_list(76),            x=[ZERO,ZERO,ZERO],            u=[ZERO,ZERO,ZERO])
  call update(node_list(77),            x=[ZERO,ZERO,ZERO],            u=[ZERO,ZERO,ZERO])
  call update(node_list(78),            x=[ZERO,ZERO,ZERO],            u=[ZERO,ZERO,ZERO])
  call update(node_list(79),            x=[ZERO,ZERO,ZERO],            u=[ZERO,ZERO,ZERO])
  call update(node_list(80),            x=[ZERO,ZERO,ZERO],            u=[ZERO,ZERO,ZERO])
